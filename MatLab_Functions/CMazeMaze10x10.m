...
classdef CMazeMaze10x10
    ...
    methods
        ...
        function DrawMaze(f)
            ...
            fontSize = 20;
            hold on
            h=title(sprintf('10578755: Maze with %d x-axis X %d y-axis cells', f.xStateCnt, f.yStateCnt));
            ...
            for x=1:f.xStateCnt
                for y=1:f.yStateCnt
                    ...
                    text(f.textLowerPoint(x,y,1),f.textLowerPoint(x,y,2), stateNameID, 'FontSize', 15)
                end
            end
        end
        ...
        function DrawMazeWithArm(f,solution,P1,P2,origin)
            ...
            for i = 1: 19
                ...
                set(h, 'LineWidth', 2);
%                 legend('Origin','Lines','Elbow Points', 'End Points');
                pause(1);
            end
        end
        ...
        function f = SimpleMaze10x10(f)
            ...
            % example only
            blockedLocations = [1 6; 1 7; 1 8; 1 9; 1 10; 2 1; 2 3; 2 4; 3 4; 3 5;
                3 6; 3 7; 3 9; 4 2; 4 5; 4 7; 4 9; 5 2; 5 3; 5 5; 5 7; 5 9; 6 2; 6 3;
                7 2; 7 3; 7 5; 7 6; 7 7; 7 9; 8 3; 8 5; 8 6; 8 7; 8 9; 9 1; 9 3; 9 4; 9 5; 9 7; 9 9; 10 1; 10 7;];
            % YOUR CODE GOES HERE
